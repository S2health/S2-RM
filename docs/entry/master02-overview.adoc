...
[.text-center]
.gcm.entry package
image::{uml_diagrams_uri}/RM-2.1-entry-taxonomy.svg[id=entry_taxonomy, align="center"]
...
[.text-center]
.Entry state machine
image::{uml_diagrams_uri}/RM-Entry_state_machine.svg[id=Entry_state_machine, align="center"]
