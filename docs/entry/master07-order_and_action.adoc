...
[.text-center]
.Order and Action
image::{uml_diagrams_uri}/GRM-entry-order.svg[id=entry_order, align="center"]
...
image::{uml_diagrams_uri}/GRM-order_state_machine.svg[id=Order_state_machine, align="center"]
...
include::{uml_export_dir}/classes/{pkg}order_execution_states.adoc[]

include::{uml_export_dir}/classes/{pkg}order_execution_transitions.adoc[]
