...
[.text-center]
.Order and Action
image::{uml_diagrams_uri}/RM-entry-order.svg[id=entry_order, align="center"]
...
image::{uml_diagrams_uri}/RM-order_state_machine.svg[id=Order_state_machine, align="center"]
