...
:pkg: org.graphite.gcm.entry.
endif::[]

include::master01-preface.adoc[leveloffset=+1]
include::master02-overview.adoc[leveloffset=+1]
include::master03-entry.adoc[leveloffset=+1]
include::master04-observation.adoc[leveloffset=+1]
include::master05-questionnaire.adoc[leveloffset=+1]
include::master06-assertion.adoc[leveloffset=+1]
