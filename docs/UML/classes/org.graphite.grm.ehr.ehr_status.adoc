...
h|*1..1*
|*subject*: `link:/releases/BASE/{base_release}/base_types.html#_party_self_class[Party_self^]`
...
h|*0..1*
|*other_details*: `link:/releases/GRM/{grm_release}/data_structures.html#_cluster_class[Cluster^]`
