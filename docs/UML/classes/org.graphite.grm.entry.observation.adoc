...
h|*1..1*
|*data*: `List<link:/releases/GRM/{grm_release}/data_structures.html#_item_class[Item^]>`
a|Result.

h|*0..1*
|*state*: `List<link:/releases/GRM/{grm_release}/data_structures.html#_item_class[Item^]>`
