...
h|*Inherit*
2+|`link:/releases/S2-CARE/{care_release}/docs/ehr.html#_content_item_class[Content_item^]`
...
h|*1..1*
|*data*: `link:/releases/S2-BASE/{base_release}/docs/patterns.html#_node_class[Node^]`
