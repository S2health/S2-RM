...
h|*0..1*
|*state_series*: `List<link:/releases/RM/{rm_release}/data_structures.html#_event_class[Event^]>`
...
h|*0..1*
|*data_series*: `List<link:/releases/RM/{rm_release}/data_structures.html#_event_class[Event^]>`
