...
h|*Inherit*
2+|`link:/releases/BASE/{base_release}/base_types.html#_pathable_class[Pathable^]`
...
h|*0..1*
|*other_context*: `link:/releases/GCM/{gcm_release}/data_structures.html#_cluster_class[Cluster^]`
