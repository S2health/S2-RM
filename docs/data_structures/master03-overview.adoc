...
The `rm.data_structures` package contains classes representing structures for recording events in past time. The
`data_structures package` is illustrated below.

[.text-center]
.rm.data_structures Package
image::{uml_diagrams_uri}/GCM-data_structures.svg[id=data_structures_package, align="center"]

== Representation Classes

These classes support a simple hierarchical representation of any data structure, as shown on the right side of <<data_structures_package>>.

=== Class Descriptions

include::{uml_export_dir}/classes/{pkg}item.adoc[leveloffset=+1]

include::{uml_export_dir}/classes/{pkg}cluster.adoc[leveloffset=+1]

include::{uml_export_dir}/classes/{pkg}element.adoc[leveloffset=+1]
...
include::{uml_export_dir}/classes/{pkg}history.adoc[leveloffset=+1]

include::{uml_export_dir}/classes/{pkg}event.adoc[leveloffset=+1]

include::{uml_export_dir}/classes/{pkg}pointevent.adoc[leveloffset=+1]

include::{uml_export_dir}/classes/{pkg}intervalevent.adoc[leveloffset=+1]
