...
:description: Graphite Canonical Model
...
:numbered!:
= Graphite Canonical Model - {rm_release}
...
|link:/UML/Graphite_UML-GCM.mdzip[Graphite_UML-GCM.mdzip]
