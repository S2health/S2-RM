...
include::{uml_export_dir}/classes/{pkg}datavalue.adoc[]

include::{uml_export_dir}/classes/{pkg}dvboolean.adoc[]

include::{uml_export_dir}/classes/{pkg}dvidentifier.adoc[]
