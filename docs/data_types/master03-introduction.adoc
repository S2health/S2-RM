...
The package structure of the Graphite data types is illustrated below.

[.text-center]
.rm.data_types packages
image::{uml_diagrams_uri}/GCM-data_types-packages.svg[id=rm_data_types_packages, align="center"]
